...
<body>
  <div class="layout">
    ...
    <main class="content">
      ...
      <div class="card p-4">
        ...
        <div class="text-muted small mt-3" id="pgInfo">Tổng: <strong>${fn:length(parts)}</strong> loại phụ tùng</div>
  ...
  <script>
    ...
    function applyAll() {
      ...
      const rows = Array.from(document.querySelectorAll('#partsTable tbody tr'));
      ...
      document.getElementById('pgInfo').innerHTML =
        'Hiển thị <strong>' + (total===0?0:from+1) + '\u2013' + to + '<\/strong> / <strong>' + total + '<\/strong> loại phụ tùng';
